...
### modelforge agent (MCP)

Alongside the analysis engine, this repo wires in
...
client that reads project `.mcp.json` (e.g. Claude Code) and the `modelforge`
...
[`docs/MODELFORGE.md`](docs/MODELFORGE.md).
